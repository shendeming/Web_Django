...
urlpatterns = [
    ...
    path('user/insert', user.insert, name="myadmin_user_insert"),         # 执行添加操作
    path('user/del/<int:uid>', user.delete, name="myadmin_user_delete"),            # 执行删除操作
    ...
    path('shop/insert', shop.insert, name="myadmin_shop_insert"),         # 执行添加操作
    path('shop/del/<int:sid>', shop.delete, name="myadmin_shop_delete"),            # 执行删除操作
